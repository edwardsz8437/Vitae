...
public class Event_Day_11th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_11th window = new Event_Day_11th();
	...
	private void initialize() {
		...
		Day eleventh = new Day("Janurary", 11, 2019, 0, 0, 000.00);
		boolean edit = false;
