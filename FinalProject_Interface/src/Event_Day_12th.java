...
public class Event_Day_12th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_12th window = new Event_Day_12th();
	...
	{
		Day first = new Day("Janurary", 12, 2000, 0, 0, 0);
		frame = new JFrame();
