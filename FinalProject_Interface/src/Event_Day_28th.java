...
public class Event_Day_28th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_28th window = new Event_Day_28th();
	...
	private void initialize() {
		...
		Day twentyEighth = new Day("Janurary", 28, 2019, 0, 0, 000.00);
		boolean edit = false;
