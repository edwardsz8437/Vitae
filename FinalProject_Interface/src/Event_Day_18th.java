...
public class Event_Day_18th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_18th window = new Event_Day_18th();
	...
	private void initialize() {
		...
		Day eighteenth = new Day("Janurary", 18, 2019, 0, 0, 000.00);
		boolean edit = false;
