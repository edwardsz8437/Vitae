...
public class Event_Day_19th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_19th window = new Event_Day_19th();
	...
	private void initialize() {
		...
		Day ninteenth = new Day("Janurary", 19, 2019, 0, 0, 000.00);
		boolean edit = false;
