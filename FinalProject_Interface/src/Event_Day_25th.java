...
public class Event_Day_25th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_25th window = new Event_Day_25th();
	...
	private void initialize() {
		...
		Day twentyFifth = new Day("Janurary", 25, 2019, 0, 0, 000.00);
		boolean edit = false;
