...
public class Event_Day_16th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_16th window = new Event_Day_16th();
	...
	private void initialize() {
		...
		Day sixteenth = new Day("Janurary", 16, 2019, 0, 0, 000.00);
		boolean edit = false;
