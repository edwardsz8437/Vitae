...
public class Event_Day_17th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_17th window = new Event_Day_17th();
	...
	private void initialize() {
		...
		Day seventeenth = new Day("Janurary", 17, 2019, 0, 0, 000.00);
		boolean edit = false;
