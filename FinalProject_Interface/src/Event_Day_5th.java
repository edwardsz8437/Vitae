...
public class Event_Day_5th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_5th window = new Event_Day_5th();
	...
	private void initialize() {
		...
		Day fifth = new Day("Janurary", 5, 2019, 0, 0, 000.00);
		boolean edit = false;
