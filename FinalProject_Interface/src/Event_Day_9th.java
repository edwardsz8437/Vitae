...
public class Event_Day_9th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_9th window = new Event_Day_9th();
	...
	private void initialize() {
		...
		Day ninth = new Day("Janurary", 9, 2019, 0, 0, 000.00);
		boolean edit = false;
