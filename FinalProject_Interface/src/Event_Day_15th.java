...
public class Event_Day_15th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_15th window = new Event_Day_15th();
	...
	{
		Day first = new Day("Janurary", 15, 2000, 0, 0, 0);
		frame = new JFrame();
