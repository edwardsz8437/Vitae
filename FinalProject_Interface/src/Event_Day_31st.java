...
public class Event_Day_31st {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_31st window = new Event_Day_31st();
	...
	private void initialize() {
		...
		Day thirtyFirst = new Day("Janurary", 31, 2019, 0, 0, 000.00);
		boolean edit = false;
