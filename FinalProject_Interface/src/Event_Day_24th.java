...
public class Event_Day_24th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_24th window = new Event_Day_24th();
	...
	private void initialize() {
		...
		Day twentyFourth = new Day("Janurary", 24, 2019, 0, 0, 000.00);
		boolean edit = false;
