...
public class Event_Day_8th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_8th window = new Event_Day_8th();
	...
	private void initialize() {
		...
		Day eight = new Day("Janurary", 8, 2019, 0, 0, 000.00);
		boolean edit = false;
