...
public class Event_Day_7th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_7th window = new Event_Day_7th();
	...
	private void initialize() {
		...
		Day seventh = new Day("Janurary", 7, 2019, 0, 0, 000.00);
		boolean edit = false;
