...
public class Event_Day_13th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_13th window = new Event_Day_13th();
	...
	private void initialize() {
		...
		Day thirteenth = new Day("Janurary", 13, 2019, 0, 0, 000.00);
		boolean edit = false;
