...
public class Event_Day_4th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_4th window = new Event_Day_4th();
	...
	private void initialize() {
		...
		Day fourth = new Day("Janurary", 4, 2019, 0, 0, 000.00);
		boolean edit = false;
