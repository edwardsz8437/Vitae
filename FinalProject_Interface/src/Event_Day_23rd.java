...
public class Event_Day_23rd {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_23rd window = new Event_Day_23rd();
	...
	private void initialize() {
		...
		Day twentyThird = new Day("Janurary", 23, 2019, 0, 0, 000.00);
		boolean edit = false;
