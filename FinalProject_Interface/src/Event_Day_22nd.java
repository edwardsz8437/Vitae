...
public class Event_Day_22nd {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_22nd window = new Event_Day_22nd();
	...
	private void initialize() {
		...
		Day twentySecond = new Day("Janurary", 22, 2019, 0, 0, 000.00);
		boolean edit = false;
