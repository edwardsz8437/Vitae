...
public class Event_Day_10th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_10th window = new Event_Day_10th();
	...
	private void initialize() {
		...
		Day tenth = new Day("Janurary", 10, 2019, 0, 0, 000.00);
		boolean edit = false;
