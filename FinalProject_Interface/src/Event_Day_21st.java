...
public class Event_Day_21st {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_21st window = new Event_Day_21st();
	...
	{
		Day first = new Day("Janurary", 21, 2000, 0, 0, 0);
		frame = new JFrame();
