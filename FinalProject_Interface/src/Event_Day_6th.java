...
public class Event_Day_6th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_6th window = new Event_Day_6th();
	...
	private void initialize() {
		...
		Day sixth = new Day("Janurary", 6, 2019, 0, 0, 000.00);
		boolean edit = false;
