...
public class Event_Day_26th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_26th window = new Event_Day_26th();
	...
	private void initialize() {
		...
		Day twentySixth = new Day("Janurary", 26, 2019, 0, 0, 000.00);
		boolean edit = false;
