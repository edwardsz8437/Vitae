...
public class Event_Day_27th {
	...
	public static void openDayUI() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Event_Day_27th window = new Event_Day_27th();
	...
	private void initialize() {
		...
		Day twentySeventh = new Day("Janurary", 27, 2019, 0, 0, 000.00);
		boolean edit = false;
		...
		txtDouble.setText("" + twentySeventh.getSleepAmount());
		txtDouble.setColumns(10);
		
		txtDouble_1 = new JTextField();
		txtDouble_1.setEditable(edit);
		txtDouble_1.setText("$" + twentySeventh.getFinances());
		txtDouble_1.setColumns(10);
		
		txtInt = new JTextField();
		txtInt.setEditable(edit);
		txtInt.setText("" + twentySeventh.getMoodLevel());
		txtInt.setColumns(10);
		
		txtMonthDay = new JTextField();
		txtMonthDay.setEditable(edit);
		txtMonthDay.setText(twentySeventh.getMonthName() + " " + twentySeventh.getDate() + ", " + twentySeventh.getYearNum());
